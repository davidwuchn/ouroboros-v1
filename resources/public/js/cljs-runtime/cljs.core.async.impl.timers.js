...
var i_36675 = (self__.level + (1));
while(true){
if((i_36675 <= (new_level + (1)))){
(update[i_36675] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_36692 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_36692[i]));
} else {
x__$2.forward.push((((i < links_36692.length))?(links_36692[i]):null));
}

if((i < links_36692.length)){
(links_36692[i] = x__$2);
} else {
links_36692.push(x__$2);
}
...
var i_36694 = (0);
while(true){
if((i_36694 <= self__.level)){
var links_36695 = (update[i_36694]).forward;
if((x__$1 === (((i_36694 < links_36695.length))?(links_36695[i_36694]):null))){
(links_36695[i_36694] = (x__$1.forward[i_36694]));

var G__36696 = (i_36694 + (1));
i_36694 = G__36696;
continue;
} else {
var G__36697 = (i_36694 + (1));
i_36694 = G__36697;
continue;
}
} else {
...
var G__36705 = nx;
var G__36706 = (level__$1 - (1));
x = G__36705;
level__$1 = G__36706;
continue;
} else {
var G__36707 = x;
var G__36708 = (level__$1 - (1));
x = G__36707;
level__$1 = G__36708;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__36713 = nx;
var G__36714 = (level__$1 - (1));
x = G__36713;
level__$1 = G__36714;
continue;
} else {
var G__36715 = x;
var G__36716 = (level__$1 - (1));
x = G__36715;
level__$1 = G__36716;
continue;
}
