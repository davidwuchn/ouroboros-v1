...
var G__50156 = clojure.zip.node(loc);
var fexpr__50155 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__50155.cljs$core$IFn$_invoke$arity$1 ? fexpr__50155.cljs$core$IFn$_invoke$arity$1(G__50156) : fexpr__50155.call(null, G__50156));
});
/**
...
var G__50159 = clojure.zip.node(loc);
var fexpr__50158 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__50158.cljs$core$IFn$_invoke$arity$1 ? fexpr__50158.cljs$core$IFn$_invoke$arity$1(G__50159) : fexpr__50158.call(null, G__50159));
} else {
...
var fexpr__50163 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__50163.cljs$core$IFn$_invoke$arity$2 ? fexpr__50163.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__50163.call(null, node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__50167 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50167,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50167,(1),null);
var vec__50170 = clojure.zip.children(loc);
var seq__50171 = cljs.core.seq(vec__50170);
var first__50172 = cljs.core.first(seq__50171);
var seq__50171__$1 = cljs.core.next(seq__50171);
var c = first__50172;
var cnext = seq__50171__$1;
var cs = vec__50170;
...
var vec__50175 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50175,(0),null);
...
var path = map__50178__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50178__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50178__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50178__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50178__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50178__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__50188 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50187__$1,new cljs.core.Keyword(null,"r","r",-471384190));
...
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50196__$1,new cljs.core.Keyword(null,"l","l",1395893423));
...
var vec__50208 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50208,(0),null);
...
var path = map__50211__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50211__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50211__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5000__auto__ = path;
if(cljs.core.truth_(and__5000__auto__)){
return cljs.core.seq(l);
} else {
...
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50228,(1),null);
...
var len__5726__auto___50280 = arguments.length;
var i__5727__auto___50281 = (0);
while(true){
if((i__5727__auto___50281 < len__5726__auto___50280)){
args__5732__auto__.push((arguments[i__5727__auto___50281]));

var G__50283 = (i__5727__auto___50281 + (1));
i__5727__auto___50281 = G__50283;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq50232){
var G__50233 = cljs.core.first(seq50232);
var seq50232__$1 = cljs.core.next(seq50232);
var G__50234 = cljs.core.first(seq50232__$1);
var seq50232__$2 = cljs.core.next(seq50232__$1);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50233,G__50234,seq50232__$2);
}));
...
var loc__$1 = lloc;
while(true){
var temp__5823__auto____$1 = (function (){var and__5000__auto__ = clojure.zip.branch_QMARK_(loc__$1);
if(cljs.core.truth_(and__5000__auto__)){
...
var G__50285 = clojure.zip.rightmost(child);
loc__$1 = G__50285;
continue;
} else {
return loc__$1;
...
var vec__50255 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50255,(0),null);
var map__50258 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50255,(1),null);
var map__50258__$1 = cljs.core.__destructure_map(map__50258);
var path = map__50258__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50258__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50258__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50258__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50258__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
while(true){
var temp__5823__auto__ = (function (){var and__5000__auto__ = clojure.zip.branch_QMARK_(loc__$1);
if(cljs.core.truth_(and__5000__auto__)){
return clojure.zip.down(loc__$1);
} else {
return and__5000__auto__;
...
var G__50286 = clojure.zip.rightmost(child);
loc__$1 = G__50286;
continue;
} else {
return loc__$1;
