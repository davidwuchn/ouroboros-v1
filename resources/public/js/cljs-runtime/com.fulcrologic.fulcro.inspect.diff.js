...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (adds,p__30498){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (rems,p__30509){
...
var temp__5823__auto__ = cljs.core.find(b,k);
if(cljs.core.truth_(temp__5823__auto__)){
var vec__30513 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30513,(0),null);
var vb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30513,(1),null);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(rems,(function (){var G__30518 = k;
if(cljs.core.map_QMARK_(k)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__30518,new cljs.core.Keyword("fulcro.inspect.lib.diff","key?","fulcro.inspect.lib.diff/key?",325118813),true);
} else {
return G__30518;
}
})());
...
com.fulcrologic.fulcro.inspect.diff.patch_updates = (function com$fulcrologic$fulcro$inspect$diff$patch_updates(x,p__30540){
var map__30542 = p__30540;
var map__30542__$1 = cljs.core.__destructure_map(map__30542);
var updates = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30542__$1,new cljs.core.Keyword("fulcro.inspect.lib.diff","updates","fulcro.inspect.lib.diff/updates",221795125));
...
com.fulcrologic.fulcro.inspect.diff.patch_removals = (function com$fulcrologic$fulcro$inspect$diff$patch_removals(x,p__30554){
var map__30555 = p__30554;
var map__30555__$1 = cljs.core.__destructure_map(map__30555);
var removals = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30555__$1,new cljs.core.Keyword("fulcro.inspect.lib.diff","removals","fulcro.inspect.lib.diff/removals",-1638817439));
...
var vec__30561 = cljs.core.first(rem);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30561,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30561,(1),null);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(final$,k,(function (p1__30549_SHARP_){
var G__30569 = p1__30549_SHARP_;
var G__30570 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("fulcro.inspect.lib.diff","removals","fulcro.inspect.lib.diff/removals",-1638817439),v], null);
return (com.fulcrologic.fulcro.inspect.diff.patch_removals.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.inspect.diff.patch_removals.cljs$core$IFn$_invoke$arity$2(G__30569,G__30570) : com.fulcrologic.fulcro.inspect.diff.patch_removals.call(null, G__30569,G__30570));
}));
} else {
