...
com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_ = (function com$fulcrologic$fulcro$algorithms$indexing$index_query_STAR_(prop__GT_classes,p__49523){
var map__49525 = p__49523;
var map__49525__$1 = cljs.core.__destructure_map(map__49525);
var ast = map__49525__$1;
var parent_component = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49525__$1,new cljs.core.Keyword(null,"component","component",1555936782));
var parent_children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49525__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (idx,p__49530){
var map__49533 = p__49530;
var map__49533__$1 = cljs.core.__destructure_map(map__49533);
var child_ast = map__49533__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49533__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var dispatch_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49533__$1,new cljs.core.Keyword(null,"dispatch-key","dispatch-key",733619510));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49533__$1,new cljs.core.Keyword(null,"children","children",-940561982));
var G__49537 = idx;
var G__49537__$1 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__49537,dispatch_key,parent_key):G__49537);
var G__49537__$2 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__49537__$1,key,parent_key):G__49537__$1);
var G__49537__$3 = (((key instanceof cljs.core.Keyword))?update_index(G__49537__$2,key,parent_key):G__49537__$2);
if(cljs.core.seq(children)){
return (com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2(G__49537__$3,child_ast) : com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.call(null, G__49537__$3,child_ast));
} else {
return G__49537__$3;
}
...
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49540__$1,new cljs.core.Keyword(null,"children","children",-940561982));
 ...
 */
com.fulcrologic.fulcro.algorithms.indexing.link_query_props = (function com$fulcrologic$fulcro$algorithms$indexing$link_query_props(p__49545){
var map__49550 = p__49545;
var map__49550__$1 = cljs.core.__destructure_map(map__49550);
var ast = map__49550__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49550__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49550__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
var state_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49555__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366));
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49555__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var map__49556 = cljs.core.deref(runtime_atom);
var map__49556__$1 = cljs.core.__destructure_map(map__49556);
var root_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49556__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","root-class","com.fulcrologic.fulcro.application/root-class",-719803119));
...
var map__49571 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__49571__$1 = cljs.core.__destructure_map(map__49571);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49571__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
...
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$14(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"info","info",-317069002),"com.fulcrologic.fulcro.algorithms.indexing","jar:file:/Users/davidwu/.m2/repository/com/fulcrologic/fulcro/3.7.10/fulcro-3.7.10.jar!/com/fulcrologic/fulcro/algorithms/indexing.cljc",99,11,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay((function (){
...
var map__49596 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__49596__$1 = cljs.core.__destructure_map(map__49596);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49596__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var cls = com.fulcrologic.fulcro.raw.components.component_type(this$);
...
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$14(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"trace","trace",-1082747415),"com.fulcrologic.fulcro.algorithms.indexing","jar:file:/Users/davidwu/.m2/repository/com/fulcrologic/fulcro/3.7.10/fulcro-3.7.10.jar!/com/fulcrologic/fulcro/algorithms/indexing.cljc",121,8,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay((function (){
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),(function com$fulcrologic$fulcro$algorithms$indexing$action(p__49625){
var map__49628 = p__49625;
var map__49628__$1 = cljs.core.__destructure_map(map__49628);
var app = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49628__$1,new cljs.core.Keyword(null,"app","app",-560961707));
var _STAR_after_render_STAR__orig_val__49630_49701 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__49631_49702 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__49631_49702);

try{if(cljs.core.truth_(app)){
com.fulcrologic.fulcro.algorithms.indexing.index_root_BANG_(app);
} else {
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$14(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"error","error",-978969032),"com.fulcrologic.fulcro.algorithms.indexing","jar:file:/Users/davidwu/.m2/repository/com/fulcrologic/fulcro/3.7.10/fulcro-3.7.10.jar!/com/fulcrologic/fulcro/algorithms/indexing.cljc",134,7,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay((function (){
...
}),null)),null,(96),null,null,null);
}
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__49630_49701);
}
return null;
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (env){
var _STAR_after_render_STAR__orig_val__49639 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__49640 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__49640);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__49639);
}})], null);
}));
