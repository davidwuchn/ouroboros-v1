...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38854_SHARP_){
return expound.printer.str_width(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__38854_SHARP_,i))));
}),rows));
});
expound.printer.max_row_height = (function expound$printer$max_row_height(row){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38856_SHARP_){
return cljs.core.count(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__38856_SHARP_)));
}),row));
});
...
var G__38857 = ["%-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(column_widths,i)),"s"].join('');
var G__38858 = v;
return (expound.printer.format.cljs$core$IFn$_invoke$arity$2 ? expound.printer.format.cljs$core$IFn$_invoke$arity$2(G__38857,G__38858) : expound.printer.format.call(null, G__38857,G__38858));
}),row);
}),multi_row);
}),multi_rows);
});
...
var columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38861_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__38861_SHARP_)).length),"-"));
}),header);
var header_columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38863_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__38863_SHARP_)).length),"="));
}),header);
...
var iter__5480__auto__ = (function expound$printer$multirow_$_iter__38866(s__38867){
return (new cljs.core.LazySeq(null,(function (){
var s__38867__$1 = s__38867;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__38867__$1);
if(temp__5825__auto__){
var s__38867__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__38867__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__38867__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__38869 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__38868 = (0);
while(true){
if((i__38868 < size__5479__auto__)){
var row_idx = cljs.core._nth(c__5478__auto__,i__38868);
cljs.core.chunk_append(b__38869,(function (){var iter__5480__auto__ = ((function (i__38868,row_idx,c__5478__auto__,size__5479__auto__,b__38869,s__38867__$2,temp__5825__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__38866_$_iter__38870(s__38871){
return (new cljs.core.LazySeq(null,((function (i__38868,row_idx,c__5478__auto__,size__5479__auto__,b__38869,s__38867__$2,temp__5825__auto__,split_row_contents){
return (function (){
var s__38871__$1 = s__38871;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__38871__$1);
if(temp__5825__auto____$1){
var s__38871__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__38871__$2)){
var c__5478__auto____$1 = cljs.core.chunk_first(s__38871__$2);
var size__5479__auto____$1 = cljs.core.count(c__5478__auto____$1);
var b__38873 = cljs.core.chunk_buffer(size__5479__auto____$1);
if((function (){var i__38872 = (0);
while(true){
if((i__38872 < size__5479__auto____$1)){
var col_idx = cljs.core._nth(c__5478__auto____$1,i__38872);
cljs.core.chunk_append(b__38873,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__39454 = (i__38872 + (1));
i__38872 = G__39454;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38873),expound$printer$multirow_$_iter__38866_$_iter__38870(cljs.core.chunk_rest(s__38871__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38873),null);
}
} else {
var col_idx = cljs.core.first(s__38871__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__38866_$_iter__38870(cljs.core.rest(s__38871__$2)));
}
} else {
return null;
}
...
});})(i__38868,row_idx,c__5478__auto__,size__5479__auto__,b__38869,s__38867__$2,temp__5825__auto__,split_row_contents))
,null,null));
});})(i__38868,row_idx,c__5478__auto__,size__5479__auto__,b__38869,s__38867__$2,temp__5825__auto__,split_row_contents))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38869),expound$printer$multirow_$_iter__38866(cljs.core.chunk_rest(s__38867__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38869),null);
}
} else {
var row_idx = cljs.core.first(s__38867__$2);
return cljs.core.cons((function (){var iter__5480__auto__ = ((function (row_idx,s__38867__$2,temp__5825__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__38866_$_iter__38879(s__38880){
return (new cljs.core.LazySeq(null,(function (){
var s__38880__$1 = s__38880;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__38880__$1);
if(temp__5825__auto____$1){
var s__38880__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__38880__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__38880__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__38882 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__38881 = (0);
while(true){
if((i__38881 < size__5479__auto__)){
var col_idx = cljs.core._nth(c__5478__auto__,i__38881);
cljs.core.chunk_append(b__38882,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__39469 = (i__38881 + (1));
i__38881 = G__39469;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38882),expound$printer$multirow_$_iter__38866_$_iter__38879(cljs.core.chunk_rest(s__38880__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38882),null);
}
} else {
var col_idx = cljs.core.first(s__38880__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__38866_$_iter__38879(cljs.core.rest(s__38880__$2)));
}
} else {
return null;
}
...
});})(row_idx,s__38867__$2,temp__5825__auto__,split_row_contents))
;
return iter__5480__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(cljs.core.count(row)));
})(),expound$printer$multirow_$_iter__38866(cljs.core.rest(s__38867__$2)));
}
} else {
return null;
}
...
var rows = cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [column_keys], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38928_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(p1__38928_SHARP_,column_keys);
}),map_rows));
...
var form = (function (){var G__39025 = via;
var G__39025__$1 = (((G__39025 == null))?null:cljs.core.last(G__39025));
if((G__39025__$1 == null)){
return null;
} else {
return cljs.spec.alpha.form(G__39025__$1);
}
})();
var keys_specs = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__39022_SHARP_){
return cljs.spec.alpha.valid_QMARK_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("expound.spec","keys-spec","expound.spec/keys-spec",-1760201532),p1__39022_SHARP_);
...
}),cljs.core.tree_seq(cljs.core.coll_QMARK_,cljs.core.seq,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"specs","specs",1426570741),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"clauses","clauses",1454841241),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39023_SHARP_){
return cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","keys-spec","expound.spec/keys-spec",-1760201532),p1__39023_SHARP_);
}),keys_specs)], 0))], 0))))));
}
});
expound.printer.key__GT_spec = (function expound$printer$key__GT_spec(keys,problems){
var seq__39043_39529 = cljs.core.seq(problems);
var chunk__39044_39531 = null;
var count__39045_39532 = (0);
var i__39046_39533 = (0);
while(true){
if((i__39046_39533 < count__39045_39532)){
var p_39535 = chunk__39044_39531.cljs$core$IIndexed$_nth$arity$2(null, i__39046_39533);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_39535) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__39542 = seq__39043_39529;
var G__39543 = chunk__39044_39531;
var G__39544 = count__39045_39532;
var G__39545 = (i__39046_39533 + (1));
seq__39043_39529 = G__39542;
chunk__39044_39531 = G__39543;
count__39045_39532 = G__39544;
i__39046_39533 = G__39545;
continue;
} else {
var temp__5825__auto___39548 = cljs.core.seq(seq__39043_39529);
if(temp__5825__auto___39548){
var seq__39043_39551__$1 = temp__5825__auto___39548;
if(cljs.core.chunked_seq_QMARK_(seq__39043_39551__$1)){
var c__5525__auto___39552 = cljs.core.chunk_first(seq__39043_39551__$1);
var G__39553 = cljs.core.chunk_rest(seq__39043_39551__$1);
var G__39554 = c__5525__auto___39552;
var G__39555 = cljs.core.count(c__5525__auto___39552);
var G__39556 = (0);
seq__39043_39529 = G__39553;
chunk__39044_39531 = G__39554;
count__39045_39532 = G__39555;
i__39046_39533 = G__39556;
continue;
} else {
var p_39559 = cljs.core.first(seq__39043_39551__$1);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_39559) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__39560 = cljs.core.next(seq__39043_39551__$1);
var G__39561 = null;
var G__39562 = (0);
var G__39563 = (0);
seq__39043_39529 = G__39560;
chunk__39044_39531 = G__39561;
count__39045_39532 = G__39562;
i__39046_39533 = G__39563;
continue;
}
} else {
}
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,k,((cljs.core.qualified_keyword_QMARK_(k))?k:(function (){var or__5002__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__39042_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),cljs.core.name(p1__39042_SHARP_));
}),specs));
...
expound.printer.summarize_key_clause = (function expound$printer$summarize_key_clause(p__39075){
var vec__39078 = p__39075;
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39078,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39078,(1),null);
var G__39084 = branch;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__39084__$1)].join('')));

}
});
expound.printer.missing_key = (function expound$printer$missing_key(form){
var vec__39099 = cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","contains-key-pred","expound.spec/contains-key-pred",-989075236),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,(2)));
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39099,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39099,(1),null);
var G__39102 = branch;
...
var len__5726__auto___39624 = arguments.length;
var i__5727__auto___39625 = (0);
while(true){
if((i__5727__auto___39625 < len__5726__auto___39624)){
args__5732__auto__.push((arguments[i__5727__auto___39625]));

var G__39626 = (i__5727__auto___39625 + (1));
i__5727__auto___39625 = G__39626;
continue;
} else {
}
break;
...
/** @this {Function} */
(expound.printer.format.cljs$lang$applyTo = (function (seq39118){
var G__39119 = cljs.core.first(seq39118);
var seq39118__$1 = cljs.core.next(seq39118);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39119,seq39118__$1);
}));
...
var keys = expound.printer.keywords(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39145_SHARP_){
return expound.printer.missing_key(new cljs.core.Keyword(null,"pred","pred",1927423397).cljs$core$IFn$_invoke$arity$1(p1__39145_SHARP_));
}),problems));
...
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p1__39147_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__39147_SHARP_,"key");
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__39154){
var vec__39159 = p__39154;
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39168_SHARP_){
return expound.ansi.color.cljs$core$IFn$_invoke$arity$variadic(p1__39168_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"correct-key","correct-key",1087492967)], 0));
...
var vec__39231 = clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(s));
...
var line = first__39233;
var lines = seq__39232__$1;
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(first_line_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)].join('')], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39203_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(rest_lines_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__39203_SHARP_)].join('');
}),lines)));
}));
...
while(true){
var vec__39254 = in$;
var seq__39255 = cljs.core.seq(vec__39254);
var first__39256 = cljs.core.first(seq__39255);
var seq__39255__$1 = cljs.core.next(seq__39255);
var k = first__39256;
var rst = seq__39255__$1;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(displayed_form,new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k)),(function (){var G__39264 = show_valid_values_QMARK_;
var G__39265 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k);
var G__39266 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__39264,G__39265,G__39266) : expound.printer.summary_form.call(null, G__39264,G__39265,G__39266));
})(),new cljs.core.Keyword("expound.problems","irrelevant","expound.problems/irrelevant",2090226124));
} else {
if(((cljs.core.map_QMARK_(form)) && (expound.paths.kvps_QMARK_(k)))){
var G__39732 = show_valid_values_QMARK_;
var G__39733 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(k));
var G__39734 = rst__$1;
show_valid_values_QMARK_ = G__39732;
form = G__39733;
in$ = G__39734;
continue;
} else {
if(cljs.core.associative_QMARK_(form)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(displayed_form,k,(function (){var G__39271 = show_valid_values_QMARK_;
var G__39272 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(form,k);
var G__39273 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__39271,G__39272,G__39273) : expound.printer.summary_form.call(null, G__39271,G__39272,G__39273));
})());
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.seq_QMARK_(form)))){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__39276 = show_valid_values_QMARK_;
var G__39277 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,k);
var G__39278 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__39276,G__39277,G__39278) : expound.printer.summary_form.call(null, G__39276,G__39277,G__39278));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.set_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__39281 = show_valid_values_QMARK_;
var G__39282 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__39283 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__39281,G__39282,G__39283) : expound.printer.summary_form.call(null, G__39281,G__39282,G__39283));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.list_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.List.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__39294 = show_valid_values_QMARK_;
var G__39295 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__39296 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__39294,G__39295,G__39296) : expound.printer.summary_form.call(null, G__39294,G__39295,G__39296));
})()));
} else {
...
var max_width = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39298_SHARP_){
return ((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__39298_SHARP_)).length);
...
var map__39307 = problem;
var map__39307__$1 = cljs.core.__destructure_map(map__39307);
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39307__$1,new cljs.core.Keyword("expound","form","expound/form",-264680632));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39307__$1,new cljs.core.Keyword("expound","in","expound/in",-1900412298));
var map__39308 = opts;
var map__39308__$1 = cljs.core.__destructure_map(map__39308);
var show_valid_values_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__39308__$1,new cljs.core.Keyword(null,"show-valid-values?","show-valid-values?",-587258094),false);
...
var s = (function (){var _STAR_print_namespace_maps_STAR__orig_val__39318 = cljs.core._STAR_print_namespace_maps_STAR_;
var _STAR_print_namespace_maps_STAR__temp_val__39320 = false;
(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__temp_val__39320);
...
}finally {(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__orig_val__39318);
}})();
var vec__39309 = cljs.core.re_find(regex,s);
...
var line = first__39311;
var first__39311__$1 = cljs.core.first(seq__39310__$1);
var seq__39310__$2 = cljs.core.next(seq__39310__$1);
var prefix = first__39311__$1;
var _more = seq__39310__$2;
